...
// @section lcd
  ...
  //S1: Set all manual feedrates to the same
...
#define ADVANCED_PAUSE_FEATURE
  ...
  //S1: Set to 40                                                   // This short retract is done immediately, before parking the nozzle.
  ...
  //S1:                                          // 0 to disable start loading and skip to fast load only
