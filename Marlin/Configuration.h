...
#define DELTA
  ...
  #define DELTA_RADIUS 141.0              // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 397 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -39, 0 }
...
#define Z_CLEARANCE_BETWEEN_PROBES 16 // Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE    16 // Z Clearance between multiple probes
