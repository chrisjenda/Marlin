...
//========================= Jenda Custom Config =============================
//===========================================================================
// Coming from FLSUN_FIRMWARE to dd76a50(2.0.x BUGFIX)
// Based on 2.0.x BUGFIX (Commit: dd76a50)
// Reason for Updating: FLSUN Firmware Sucks!
// FLSUN 32 Bit Custom Configuration
// S0: Update Config from v020007/41865b6(Apr 6, 2020) to v020008/8f5184a(3/14/2021) -
// Enabled custom versioning, set config author.
// S1: Update Config for Delta, Implement fix for FLSUN QQ-S-Pro in Pins.h file
//
// @section info

// Author info of this build printed to the host during boot and M115
#define STRING_CONFIG_H_AUTHOR "(Chris Jenda, QQS-Pro_default)" // Who made the changes.
...
#ifndef MOTHERBOARD
	//S1: Set to BOARD_FLSUN_HISPEED for QQ-S-Pro										   
...
//S1: Enable Heatbed for QQ-S-Pro								 
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
   //S1: Set PID Defaults for QQ-S-Pro
  #define DEFAULT_Kp 27.2473
  #define DEFAULT_Ki 2.3985
  #define DEFAULT_Kd 77.3824
  #endif
#endif // PIDTEMP
 ...
 */
//S1: Enable PID Heatbed for QQ-S-Pro								 
#define PIDTEMPBED
...
//S1: Increase Max Length for QQ-S-Pro									  
...
#define DELTA
  ...
  #define DELTA_HEIGHT 354.2038            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.2019, -0.1656, -0.0364 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 140.6969             // (mm) Get this value from G33 auto calibrate
...
//S1: Disable Xmin and Ymin						   
//#define USE_XMIN_PLUG
//#define USE_YMIN_PLUG
#define USE_ZMIN_PLUG // a Z probe
//S1: Enable Xmax, Ymax and Zmax								
...
#define CLASSIC_JERK
  ...
  //S1: Set all Jerk Settings to be the same for delta													  
...
//S1: Double the Probe Margin							 
#define PROBING_MARGIN 20

// X and Y axis travel speed (mm/min) between probes
//S1: Reduce Probe Feedrate from 133mm/s to 84 mm/s												   
#define XY_PROBE_FEEDRATE (84*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
//S1: Set Z probe Fast to Z Homing Speed									
#define Z_PROBE_FEEDRATE_FAST (100*60)

// Feedrate (mm/min) for the "accurate" probe of each point
//S1: Reduce slow probe speed by 33%									
...
//S1: Enable and set to delta height									
...
//S1: Increase Homing to 100 mm/s								   
...
#define NOZZLE_PARK_FEATURE
  ...
  //S1: Enable and set to delta settings										
